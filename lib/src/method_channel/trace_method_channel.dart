...
class BaiduYingYanMethodChannel
  ...
  static const MethodChannel _channel =
      const MethodChannel('flutter_baidu_yingyan_trace');

  static final BaiduYingYanMethodChannel instance =
  ...
  Map<String, bool> streamSubscriptions = {};
    ...
    switch (call.method) {
      ...
      case EntityMethods.kAddEntityCallBack:
        _streamController.sink
            .add(AddEntityEvent(AddEntityResult.fromMap(call.arguments)));
        break;
      case EntityMethods.kUpdateEntityCallBack:
        _streamController.sink
            .add(UpdateEntityEvent(UpdateEntityResult.fromMap(call.arguments)));
        break;
      case EntityMethods.kDeleteEntityCallBack:
        _streamController.sink
            .add(DeleteEntityEvent(DeleteEntityResult.fromMap(call.arguments)));
        break;
      ...
      case FenceMethods.kCreateFenceCallBack:
        _streamController.sink
            .add(CreateFenceEvent(CreateFenceResult.fromMap(call.arguments)));
        break;
      case FenceMethods.kUpdateFenceCallBack:
        _streamController.sink
            .add(UpdateFenceEvent(UpdateFenceResult.fromMap(call.arguments)));
        break;
      case FenceMethods.kDeleteFenceCallBack:
        _streamController.sink
            .add(DeleteFenceEvent(DeleteFenceResult.fromMap(call.arguments)));
        break;
  ...
  Future<bool> configServerInfo(ServiceOption serviceOption) async {
    ArgumentError.checkNotNull(serviceOption, "serviceOption");
  ...
  Future<bool> setInterval({
    ...
    ArgumentError.checkNotNull(gatherInterval, "gatherInterval");
    ArgumentError.checkNotNull(packInterval, "packInterval");
  ...
  @override
  Future<bool> configLocationInfo(
      {required LocationOption locationOption}) async {
    ArgumentError.checkNotNull(locationOption, "locationOption");
  ...
  Future<bool> setLocationMode(LocationMode locationMode) async {
    ArgumentError.checkNotNull(locationMode, "locationMode");
  ...
  Future<bool> analyzeDrivingBehaviour({
    ...
    ArgumentError.checkNotNull(drivingBehaviourAnalysisOption, "option");
  ...
  Future<bool> analyzeStayPoint({
    ...
    ArgumentError.checkNotNull(stayPointAnalysisOption, "option");
  ...
  Future<bool> addCustomPoints({
    ...
    ArgumentError.checkNotNull(addCustomTrackPointsOption, "option");
  ...
  Future<bool> addCustomPoint({
    ...
    ArgumentError.checkNotNull(addCustomTrackPointOption, "option");
    ...
    try {
      ...
      result = (await _channel.invokeMethod(
        TrackMethods.kAddCustomPoint,
        addCustomTrackPointOption.toMap(),
      )) as bool;
    } on PlatformException catch (e) {
      print(e.toString());
    }
  ...
  Future<bool> clearTrackCache({
    ...
    ArgumentError.checkNotNull(clearTrackCacheOption, "option");
    ...
    try {
      ...
      result = (await _channel.invokeMethod(
        TrackMethods.kClearTrackCache,
        clearTrackCacheOption.toMap(),
      )) as bool;
    } on PlatformException catch (e) {
      print(e.toString());
    }
  ...
  Future<bool> queryHistoryTrack({
    ...
    ArgumentError.checkNotNull(queryHistoryTrackOption, "option");
    ...
    try {
      ...
      result = (await _channel.invokeMethod(
        TrackMethods.kQueryHistoryTrack,
        queryHistoryTrackOption.toMap(),
      )) as bool;
    } on PlatformException catch (e) {
      print(e.toString());
    }
  ...
  Future<bool> queryTrackCacheInfo({
    ...
    ArgumentError.checkNotNull(queryTrackCacheInfoOption, "option");
  ...
  Future<bool> queryTrackDistance({
    ...
    ArgumentError.checkNotNull(queryTrackDistanceOption, "option");
  ...
  Future<bool> queryTrackLatestPoint({
    ...
    ArgumentError.checkNotNull(queryTrackLatestPointOption, "option");
  ...
  Future<bool> addEntity({
    ...
    ArgumentError.checkNotNull(addEntityOption, "option");
  ...
  Future<bool> aroundSearchEntity({
    ...
    ArgumentError.checkNotNull(aroundSearchEntityOption, "option");
  ...
  Future<bool> boundSearchEntity({
    ...
    ArgumentError.checkNotNull(boundSearchEntityOption, "option");
  ...
  Future<bool> deleteEntity({
    ...
    ArgumentError.checkNotNull(deleteEntityOption, "option");
  ...
  Future<bool> districtSearchEntity({
    ...
    ArgumentError.checkNotNull(districtSearchEntityOption, "option");
  ...
  Future<bool> polygonSearchEntity({
    ...
    ArgumentError.checkNotNull(polygonSearchEntityOption, "option");
  ...
  Future<bool> queryEntityList({
    ...
    ArgumentError.checkNotNull(entityListSearchOption, "option");
    ...
    try {
      ...
      result = (await _channel.invokeMethod(
        EntityMethods.kQueryEntityList,
        entityListSearchOption.toMap(),
      )) as bool;
    } on PlatformException catch (e) {
      print(e.toString());
    }
  ...
  Future<bool> keyWordSearchEntity({
    ...
    ArgumentError.checkNotNull(keyWordSearchEntityOption, "option");
    ...
    try {
      ...
      result = (await _channel.invokeMethod(
        EntityMethods.kSearchEntity,
        keyWordSearchEntityOption.toMap(),
      )) as bool;
    } on PlatformException catch (e) {
      print(e.toString());
    }
  ...
  Future<bool> updateEntity({
    ...
    ArgumentError.checkNotNull(updateEntityOption, "option");
    ...
    try {
      ...
      result = (await _channel.invokeMethod(
        EntityMethods.kUpdateEntity,
        updateEntityOption.toMap(),
      )) as bool;
    } on PlatformException catch (e) {
      print(e.toString());
    }
  ...
  Future<bool> addMonitoredPerson({
    ...
    ArgumentError.checkNotNull(addMonitoredPersonOption, "option");
  ...
  Future<bool> createFence({
    ...
    ArgumentError.checkNotNull(createFenceOption, "option");
  ...
  Future<bool> deleteFence({
    ...
    ArgumentError.checkNotNull(deleteFenceOption, "option");
  ...
  Future<bool> deleteMonitoredPerson({
    ...
    ArgumentError.checkNotNull(deleteMonitoredPersonOption, "option");
  ...
  Future<bool> queryFenceList({
    ...
    ArgumentError.checkNotNull(queryFenceListOption, "option");
  ...
  Future<bool> queryHistoryAlarm({
    ...
    ArgumentError.checkNotNull(queryHistoryAlarmOption, "option");
    ...
    try {
      ...
      result = (await _channel.invokeMethod(
              FenceMethods.kQueryHistoryAlarm, queryHistoryAlarmOption.toMap()))
          as bool;
    } on PlatformException catch (e) {
      print(e.toString());
    }
  ...
  Future<bool> queryListMonitoredPerson(
    ...
    ArgumentError.checkNotNull(queryListMonitoredPersonOption, "option");
  ...
  Future<bool> queryMonitoredStatus({
    ...
    ArgumentError.checkNotNull(queryMonitoredStatusOption, "option");
  ...
  Future<bool> queryMonitoredStatusByLocation({
    ...
    ArgumentError.checkNotNull(queryMonitoredStatusByLocationOption, "option");
  ...
  Future<bool> updateFence({
    ...
    ArgumentError.checkNotNull(updateFenceOption, "option");
  ...
  Future<bool> queryRealTimeLoc({
    ...
    ArgumentError.checkNotNull(realTimeLocationOption, "option");
    ...
    try {
      ...
      result = (await _channel.invokeMethod(
        EntityMethods.kQueryRealTimeLoc,
        realTimeLocationOption.toMap(),
      )) as bool;
    } on PlatformException catch (e) {
      print(e.toString());
    }
  ...
  Future<void> stopRealTimeLoc() async {
    // bool result = false;
    try {
      await _channel.invokeMethod(CommonMethods.kStopRealTimeLoc);
    } on PlatformException catch (e) {
      print(e.toString());
    }
    // return result;
