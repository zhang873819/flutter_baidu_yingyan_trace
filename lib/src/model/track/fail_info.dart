...
class FailInfo {
  ...
  FailInfo.fromMap(Map map) : assert(map != null) { // ignore: unnecessary_null_comparison
...
class InternalError {
  ...
  InternalError.fromMap(Map map) : assert(map != null) { // ignore: unnecessary_null_comparison
