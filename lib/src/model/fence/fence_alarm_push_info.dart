...
class FenceAlarmPushInfo {
  ...
  FenceAlarmPushInfo.fromMap(Map map) : assert(map != null) { // ignore: unnecessary_null_comparison
    fenceId = map['fenceId'];
...
class AlarmPoint {
  ...
  AlarmPoint.fromMap(Map map) : assert(map != null) { // ignore: unnecessary_null_comparison
    location =
